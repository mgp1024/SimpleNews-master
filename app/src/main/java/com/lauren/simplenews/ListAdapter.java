...
import com.lauren.simplenews.units.AsyncImageLoader;
import com.lauren.simplenews.units.FileCache;
import com.lauren.simplenews.units.MemoryCache;
...
public class ListAdapter extends BaseAdapter {
    ...
    public ListAdapter(Context context, List<String> l_title, List<String> l_img, List<String> l_content) {
